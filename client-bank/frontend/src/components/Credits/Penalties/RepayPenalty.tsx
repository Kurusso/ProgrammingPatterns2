...
export const RepayPenalty = ({penalties}: { penalties: Penalty[] }) => {
    ...
    return (
        <div>
            <h3>Repay penalty</h3>
            Penalty
            <PenaltySelect selectedPenalty={selectedPenalty} setSelectedPenalty={setSelectedPenalty}
                           penalties={penalties}/>
            ...
            <button className={"repay-penalty-btn"} onClick={HandleRepayingPenalty}>Repay Penalty</button>
        </div>
